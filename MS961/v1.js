    ...
    if (typeof $ != 'undefined') {
      ...
      if(signUpButton !== null){
        dataLayer.push({
                  ...
                  'eventLabel': 'MS961 (Variation 1) | User not logged in'
                  });
        ...
        signUp.addEventListener('click', function(){
          dataLayer.push({
                  ...
                  'eventCategory': 'Conversio CRO',
                  'eventAction': 'MS961 | Event Tracking',
                  'eventLabel': 'MS961 (Variation 1) | Log in attempt'
                  });
      ...
      function basketTimerMsg(){
        if($(".custBasketTimerMsgAS").length == 0 && $(".b-cart__package .b-cart__pack .b-cart__items").length > 0){
            $('<div class="custBasketTimerMsgAS"><p><span class="icon"></span>Items in your bag are not saved and may sell out.</p></div>').prependTo('.b-cart__package:eq(0) .b-cart__pack');
        }  
      ...
      clearInterval(waitFor$);
        ...
        dataLayer.push({
                  ...
                  'eventCategory': 'Conversio CRO',
                  'eventAction': 'MS961 | Event Tracking',
                  'eventLabel': 'MS961 (Variation 1) | User logged in'
                  });
